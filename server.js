...
app.use(function(req,res,next){//redirects anypage other than homepage to homepage.
    (req.path=='/file_upload'&&req.method.toLowerCase()=='post'||req.path=='/') ? next() : res.redirect(301,'/');
});
